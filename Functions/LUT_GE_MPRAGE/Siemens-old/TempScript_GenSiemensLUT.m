...
LUTsavDirEnd = 'LUT_files_t2_80ms_siteSpecific';
...
T1map = Siemens_2pt_Inversion_T1mapping_1pool(T1wInfo, PDwInfo, MPRAGE, PDw, B1, [], LUTsavDir, lutPrefix );
...
T1map2 = Siemens_2pt_Inversion_T1mapping_1pool(T1wInfo, PDwInfo, MPRAGE, PDw, B1, [], LUTsavDir, lutPrefix );
