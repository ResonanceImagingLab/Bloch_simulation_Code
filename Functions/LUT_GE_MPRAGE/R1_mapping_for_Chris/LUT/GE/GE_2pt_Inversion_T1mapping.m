...
function T1map = GE_2pt_Inversion_T1mapping(T1wInfo, PDwInfo, MPRAGE, PDw, B1, mask, LUTsavDir)
...
%     LUT = compute_2pt_inversion_LUT_1pool(T1wInfo, PDwInfo, T1w_b.brain_m, T1w_fftb.fft_brain_m,...
