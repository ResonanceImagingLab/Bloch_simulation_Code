function M_final = ApplySpinEvolution_1pool_v2( Params, M_in, t, MTC, Gradient )
...
M_final = [ real(M_perp2) *exp(-t/Params.T2a);...
     imag(M_perp2) *exp(-t/Params.T2a);...
     Params.M0a - (Params.M0a - M_z2)*exp(-t*Params.Raobs)] ;
