function M_out = XYmag_Spoil_1pool(Params, M_in, t, MTC, Gradient)
...
% M_in is a 3xN matrix, where N is the number of spins. 

if Params.PerfectSpoiling
    M_out = SpinEvolution_Relaxation_1pool( Params, M_in, t); % Calculate relaxation over period t
    M_out(1:2,:) = 0; % Spoil. Easier to do if you are keeping isochromats
else

    M_out = ApplySpinEvolution_1pool_v2( Params, M_in, t, MTC, Gradient );
