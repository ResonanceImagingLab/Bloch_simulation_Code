function [Beta1, Beta2] = ComputeDiffusionBetas_v2(M_in, Params, gam, G, G_t)

% For v2, we try and use a vector approach to the gradients. As in:
% Weigel, M., Schwenk, S., Kiselev, V.G., Scheffler, K., Hennig, J., 2010. Extended phase graphs with anisotropic diffusion. J. Magn. Reson. 205, 276–285. https://doi.org/10.1016/j.jmr.2010.05.011
% And seen in this code: https://github.com/lamyj/sycomore/blob/master/src/sycomore/epg/Discrete3D.cpp
