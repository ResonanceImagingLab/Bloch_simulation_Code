...
%     if SaveImgs; saveas(gcf,fullfile(SavDir,'Kspace_Order_',num2str(Params.TurboFactor),'turbofactor.png')); end
...
%     if SaveImgs; saveas(gcf,fullfile(SavDir,'Kspace_Filled_',num2str(Params.TurboFactor),'turbofactor.png')); end
%       pause(0.5)
...
ax = gca;    ax.FontSize = 20; 
    xline([xPos1 xPos2],'--','Color',[0 0 0],'LineWidth',2) %
    xline([xPos3 xPos4],':','Color',[0 0 0],'LineWidth',2) %
  xlim([-5 5])
  xticks(-5:1:5)
set(gcf,'position',[100,100,800,600])
title('ihMTR PSF')
legend( 'TF = 200','TF = 160','TF = 120','TF = 80','TF = 48','TF = 10') 
if SaveImgs; saveas(gcf,fullfile(SavDir,'ihMTR_normalized_ACROSS_turbofactors.png')); end
...
legend( 'TF = 200','TF = 160','TF = 120','TF = 80','TF = 48','TF = 10') 
title('Single PSF')
if SaveImgs; saveas(gcf,fullfile(SavDir,'Single_normalized_ACROSS_turbofactors.png')); end
...
legend( 'TF = 200','TF = 160','TF = 120','TF = 80','TF = 48','TF = 10') 
title('Dual PSF')
if SaveImgs; saveas(gcf,fullfile(SavDir,'Dual_normalized_ACROSS_turbofactors.png')); end
...
xlabel('FWHM (mm)')
ylabel('ihMTR SNR')
xline(1,'--',{'Nominal','Resolution'},'Color',[0 0.0 0],'LineWidth',2,'FontSize',18) %
