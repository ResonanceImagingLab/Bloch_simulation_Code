...
while iteration <= maxIterations
    ...
    for i = 1:num2fit % for each variable:
        ...
        if limitPerDif > 0.05
            ...
            cVal = createInvertedGaussFit([lowerLimit(i);currList(i);highLimit(i)],...
                fitMetricY);
...
save([savDir,'lowerLimit',num2str(vers),'.mat'], "lowerLimit");
save([savDir,'highLimit',num2str(vers),'.mat'], "highLimit");
