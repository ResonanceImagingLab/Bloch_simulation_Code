function [inputMag, B1_val] = CR_batch_simSequenceFunction_test(Params, varargin)
 ...
 elseif Params.boosted
    ...
    if satTime > Params.TR_MT % if sat scheme doesn't fit, go to next value...
        ...
        if necessTime > Params.TR
            ...
            [inputMag, M, time_vect] = BlochSimFlashSequence_v2(Params); % MT-weighted signal simulation        
        end
