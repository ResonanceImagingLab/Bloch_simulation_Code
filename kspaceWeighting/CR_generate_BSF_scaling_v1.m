...
% axis image; colorbar;
% 
% viewTable = reshape(fillSpace, Params.NumLines/Params.AccelerationFactor +Params.ReferenceLines, Params.NumPartitions );
% figure; imagesc( viewTable);
% axis image; colorbar;
% 
% viewTable = reshape(outKspace_s, Params.NumLines/Params.AccelerationFactor +Params.ReferenceLines, Params.NumPartitions );
% figure; imagesc( viewTable);
% axis image; colorbar;
